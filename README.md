...
* Nokia `configuration` datastore
  * [HTML tree](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_20.5.r2-nokia-conf-combined.html)
  * [Path browser](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_20.5.r2-nokia-conf-combined-paths.html)
* Nokia `state` datastore
  * [HTML tree](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_20.5.r2-nokia-state-combined.html)
  * [Path browser](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_20.5.r2-nokia-state-combined-paths.html)
...
## 3 Download
There are several ways to download the outputs for a specific release. The below examples will assume the `sros_20.5.r2` release is in question.

### 3.1 Clone with git
If git is installed it is possible to clone the artifacts for a specific tag with the following command:
```
git clone -b sros_20.5.r2 --depth 1 https://github.com/hellt/nokia-yangtree
```
...
Here are the direct links to download `sros_20.5.r2` models outputs in the respective containers:
- [sros_20.5.r2.zip](https://github.com/hellt/nokia-yangtree/archive/sros_20.5.r2.zip)
- [sros_20.5.r2.tar.gz](https://github.com/hellt/nokia-yangtree/archive/sros_20.5.r2.tar.gz)

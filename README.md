...
* Nokia `configuration` datastore
  * [HTML tree](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_19.10.r6-nokia-conf-combined.html)
  * [Path browser](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_19.10.r6-nokia-conf-combined-paths.html)
* Nokia `state` datastore
  * [HTML tree](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_19.10.r6-nokia-state-combined.html)
  * [Path browser](https://rdodin.gitlab.io/nokia-yangtree-srv/sros_19.10.r6-nokia-state-combined-paths.html)
...
## 3 Download
There are several ways to download the outputs for a specific release. The below examples will assume the `sros_19.10.r6` release is in question.

### 3.1 Clone with git
If git is installed it is possible to clone the artifacts for a specific tag with the following command:
```
git clone -b sros_19.10.r6 --depth 1 https://github.com/hellt/nokia-yangtree
```
...
Here are the direct links to download `sros_19.10.r6` models outputs in the respective containers:
- [sros_19.10.r6.zip](https://github.com/hellt/nokia-yangtree/archive/sros_19.10.r6.zip)
- [sros_19.10.r6.tar.gz](https://github.com/hellt/nokia-yangtree/archive/sros_19.10.r6.tar.gz)
